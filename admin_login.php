...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM admins WHERE username = '$username' AND pass1 = '$password' LIMIT 1";
...
<body>
    <div class="login-form">
        <form method="POST">
            ...
            <a style="font-family: cursive;" href="admin_registration_form.php">Don't have an account? Sign up</a>
        </form>
    </div>
