                    ...
                    <div class="row">
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            <div class="col-lg-8">
                                        ...
                                        <div id="single-property"
                                            ...
                                            <div class="ls-slide"
                                                ...
                                                <img width="1920" height="1080"
                                                    src="propertyimages/<?php echo $row['20']; ?>" class="ls-bg" alt="" />
                                            </div>
                                            ...
                                            <div class="ls-slide"
                                                data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                                                <img width="1920" height="1080"
                                                    src="propertyimages/<?php echo $row['21']; ?>" class="ls-bg" alt="" />
                                            </div>
                                            ...
                                            <div class="ls-slide"
                                                data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                                                <img width="1920" height="1080"
                                                    src="propertyimages/<?php echo $row['22']; ?>" class="ls-bg" alt="" />
                                            </div>
                                            ...
                                            <div class="ls-slide"
                                                data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                                                <img width="1920" height="1080"
                                                    src="propertyimages/<?php echo $row['23']; ?>" class="ls-bg" alt="" />
                                            </div>
                                            ...
                                            <div class="ls-slide"
                                                data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                                                <img width="1920" height="1080"
                                                    src="propertyimages/<?php echo $row['24']; ?>" class="ls-bg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-success text-left h5 my-2 text-md-right">Ksh
                                            <?php echo $row['12']; ?>
                                        </div>
                                ...
                                <div class="property-details">
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        ...
                                        <div id="collapseOne" class="collapse show p-4" aria-labelledby="headingOne"
                                            ...
                                            <img src="propertyimages/<?php echo $row['25']; ?>" alt="Not Available">
                                        </div>
                                        <button
                                        ...
                                        <div id="collapseTwo" class="collapse p-4" aria-labelledby="headingTwo"
                                            data-parent="#accordionExample">
                                            <img src="propertyimages/<?php echo $row['26']; ?>" alt="Not Available">
                                        </div>
                                        <button
                                            class="bg-gray hover-bg-success hover-text-white text-ordinary py-3 px-4 mb-1 w-100 text-left rounded position-relative collapsed"
                                        ...
                                        <div id="collapseThree" class="collapse p-4" aria-labelledby="headingThree"
                                            data-parent="#accordionExample">
                                            <img src="propertyimages/<?php echo $row['27']; ?>" alt="Not Available">
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-8 col-lg-9">
                                                <div class="agent-data text-ordinary mt-sm-20">
                                                    <h6 class="text-success text-capitalize">
                                                        ...
                                                        // fetching informaton for table agents to display below
                                                    
                                                        $propertyid = $row['propertyid'];

                                                        $sql = "SELECT * From agents ";
                                                        $AgentQuery = mysqli_query($conn, $sql);
                                                        $Agentrow = mysqli_fetch_array($AgentQuery);

                                                        echo $Agentrow['fname']; ?>
                                                    </h6>
                                                    <ul class="mb-3">
                                                        <li>
                                                            <?php echo $Agentrow['phone']; ?>
                                                        </li>
                                                        <li>
                                                            <?php echo $Agentrow['email']; ?>
                                                        </li>
                                                    </ul>
                        ...
                        <div class="col-lg-4">
                            ...
                            <form class="d-inline-block w-100" action="calc.php" method="post">
                                ...
                                <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4">Calculute
                                    Installment</button>
                            </form>
